...
const StudentClearanceStatus = () => {
    ...
    const handlePrint = () => {
        ...
        if (!allCleared) {
            ...
            setTimeout(() => setShowPrintErrorModal(false), 3000); // Auto-hide modal after 3 seconds
            return;
        }
                    ...
                    {showPrintErrorModal && (
                        <div className={styles.modal}>
                            <div className={styles.alertmodalContent}>
                                <p>⚠️   Finish all the clearance before proceeding to print.</p>
                            </div>
                        </div>
                    )}
            ...
            {showLogModal && (
                <div className={styles.modalBackdrop}>
                    <div className={styles.modalContent}>
                        <h3 className={styles.modalTitle}>Transaction Logs - {selectedDepartment}</h3>
